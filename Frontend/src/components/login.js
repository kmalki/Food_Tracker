          ...
          <EuiPageContent verticalPosition="center" horizontalPosition="center">
            ...
            <EuiPageContentBody>
              {this.state.succesLogin &&
                <Fragment>
                  <EuiCallOut style={{ "width": "400px" }} title="Successfully logged in !" color="success" iconType="user">
                    <p>
                      You have been successfully logged in, you will be redirected to the homepage...
                    </p>
                  </EuiCallOut>
                  <EuiSpacer />
                </Fragment>
